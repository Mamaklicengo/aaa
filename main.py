...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🧚 Qrupa əlavə edin!", url="https://t.me/bakugamebot?startgroup=a")
        sohbet = InlineKeyboardButton(text="Oyun və Söhbət Qrupumuz", url="https://t.me/sessizbaku")
        oyun = InlineKeyboardButton(text="👨 Sahib", url="https://t.me/jelilarass")
        admin = InlineKeyboardButton(text="👨🏻‍💻 Creator", url="https://t.me/edalet_22")
